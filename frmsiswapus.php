                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <?php 
                                $st = "SELECT periode, nama, metode_latihan, kelas
                                        FROM t_sista INNER JOIN t_tari ON t_sista.kode_tari = t_tari.kode
                                       WHERE no_regis = ". $_SESSION['pilSiswa'];
