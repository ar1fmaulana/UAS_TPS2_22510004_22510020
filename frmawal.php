...
<head>
    ...
    <meta name="author" content="Arif & Apgi">
                                    ...
                                    <li class="page-item <?php if ($hal <= 1) echo 'disabled';?>">
                                        ...
                                        <?php 
                                            if ($totHal < 7) {
                                                ...
                                                if ($totHal - $hal < 3) { 
                                                    // Display the last 5 pages if the current page is within the last 3 pages
                                                    $Aw = $totHal - 4;
                                                    $Ak = $totHal;
                                                } else if ($hal <= 3) {
                                                    // Display the first 5 pages if the current page is within the first 3 pages
                                                    $Aw = 1;
                                                    $Ak = 5;
                                                } else {
                                                    // Display current page in the middle of the 5 page range
                                                    $Aw = $hal - 2;
                                                    $Ak = $hal + 2;
                                                }
                                            }
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-item-center justify-content-between small">
                        <div class="text-muted">&copy; 2024 Arif & Apgi</div>
                    </div>
                </div>
            </footer>
        </div>
